...
def get_balance(participant):
    ...
    print(' => Sender transactions are: ', tx_sender)
...
while waiting_for_input:
    ...
    if user_choice == '1':
        ...
        print(' => Outputting open transactions: ', open_transactions)
    elif user_choice == '2':
        if mine_block():
            open_transactions = []
            save_data()
        ...
        print(' => Outputting participants: ', participants)
    elif user_choice == '5':
    ...
    if not verify_chain():
        ...
        break
    print(' => Balance of {}: {:6.2f}'.format('ThierryD', get_balance('ThierryD')))
else:
    print(' -> User left!')
